...
const MESSAGES = {
  fr: {
    ...
    players: "Joueurs",
    playersRequired:
      "Ajoutez au moins un joueur pour créer une feuille de scores.",
    createScoreSheet: "Créer la feuille de scores",
    onboardingTitle: "Démarrage rapide",
    onboardingAddPlayers:
      "Ajoutez les noms, un par ligne ou séparés par des virgules.",
    onboardingCreateSheet: "Créez la feuille de scores.",
    onboardingAdjustScores:
      "Touchez +/−, ou touchez un score pour plus d’options.",
    ...
    keepMenuOpen: "Garder ouvert après modification",
    delete: "Retirer",
    add: "Ajouter",
  ...
  en: {
    ...
    players: "Players",
    playersRequired: "Add at least one player to create a score sheet.",
    createScoreSheet: "Create score sheet",
    onboardingTitle: "Quick start",
    onboardingAddPlayers: "Add names, one per line or comma-separated.",
    onboardingCreateSheet: "Create the score sheet.",
    onboardingAdjustScores: "Tap +/−, or tap a score for more options.",
    ...
    deleteGroupConfirmMessage: "Existing score sheets will not be affected.",
    cancel: "Cancel",
